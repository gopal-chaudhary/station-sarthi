...
import { GeoLocationService } from '../geo-map/geo-location.service';
  ...
  private getStyles(feature: any): L.PathOptions {
    ...
    if (feature.properties && feature.properties.style) {
      return {
        ...
        fillOpacity:
          feature.properties.style.fillOpacity || defaultStyle.fillOpacity,
        dashArray:
          feature.properties.style.dashArray || defaultStyle.dashArray,
      };
    }
